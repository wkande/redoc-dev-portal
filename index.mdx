...
<Jumbotron>
  ...
  <H1>CloudUla Developer Portal</H1>
  <H2>When and how to use the CloudUla Datacenter APIs.</H2>
  <Flex p={20} justifyContent="center">
    {/* <Button inversed large to="https://app.redoc.ly">
      Redocly app
    </Button> */}
    <Button inversed transparent large to="docs/welcome.md">
      Get started
    </Button>
...
<Box my={25}>
  <SectionHeader>
    <Emphasis> REST </Emphasis> is a beautiful thing: but our 
    <Emphasis> Datacenter </Emphasis> never does!
  </SectionHeader>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/index.md" icon={icon1} header="APIs">
        CloudUla REST endpoints allow access to your equipment's monitors and stats. 
        Use them to create custom graphs or dashboards. Access data for daily, weekly or monthly
        reports.
    </ThinTile>
    <ThinTile to="developer-portal/index.md" icon={launchFastIcon} header="Webhooks">
        Our Webhooks can notify you of important metrics and alerts. We made them simple to 
        setup using a POST endpoint from your code, Postman, Insomnia, etc. Another "simple" 
        DELETE endpoint removes the webhook.
    </ThinTile>
    <ThinTile to="contact.mdx" icon={icon3} header="Datacenter">
